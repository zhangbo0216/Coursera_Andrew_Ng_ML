...
for t = 1:m
    ...
    p=Theta2'*delta3(:,t);
    delta2(:,t)=p(2:hidden_layer_size+1).*sigmoidGradient(z2');
...
t1=[zeros(hidden_layer_size,1) Theta1(:,2:input_layer_size+1)];
t2=[zeros(num_labels,1) Theta2(:,2:hidden_layer_size+1)];
